...
export async function seedRepo(urlOrPath, opts) {
    try {
        ...
        try {
            ...
            console.warn('Badge skipped');
        }
        try {
            generateAction(meta);
        }
        catch (e) {
            console.warn('Action skipped');
        }
        try {
            generateCrosspost(meta);
        }
        catch (e) {
            console.warn('Crosspost skipped');
        }
        try {
            generateErrorSnippet(meta);
        }
        catch (e) {
            console.warn('Error snippet skipped');
        }
